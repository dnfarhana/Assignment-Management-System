...
<?php
   ...
   $sqlstud = "SELECT * FROM class where class_id='$classId'";
                                ...
                                <table class="table table-bordered">
                                        <tbody>
                                            <tr>
                                                ...
                                                <input type="text" class="form-control" name="name" id="name" value="<?php echo $classname; ?>"readonly>
                                                <label>Class Code: </label>
                                                <input type="text" class="form-control" name="email" id="email" value="<?php echo $classcode; ?>"readonly>
                                                <label>Lecturer Id: </label>
                                                <input type="text" class="form-control" name="phone" id="phone"value="<?php echo $lectid; ?>"readonly>
                                        </tbody>
                                    </table>
                                </form>
                        </div>
